...
window.SBDL = (function() {
  ...
  function loadScratch1Project(id) {
    const PROJECTS_API = 'https://sccdn1.sydzy2.workers.dev/internalapi/project/$id/get/';
  ...
  function loadScratch2JSONProject(id, projectData) {
    const ASSETS_API = 'https://sccdn2.sydzy2.workers.dev/internalapi/asset/$path/get/';
  ...
  function loadScratch3Project(id) {
    const PROJECTS_API = 'https://sccdn1.sydzy2.workers.dev/$id';
    const ASSETS_API = 'https://sccdn3.sydzy2.workers.dev/internalapi/asset/$path/get/';
